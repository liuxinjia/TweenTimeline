...
namespace Cr7Sund.TweenTimeLine
{
    public class AniActionEditToolHelper
    {
        ...
        public static Texture LoadImageFromPath(string imagePath)
        {
            var texture2D = AssetDatabase.LoadAssetAtPath<Texture>(imagePath);
            if (texture2D == null)
            {
                texture2D = UnityEditor.EditorGUIUtility.IconContent("BuildSettings.Switch On@2x").image;
            }
            return texture2D;
        }
    }
